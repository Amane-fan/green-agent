...
The system SHALL return structured planning results containing per-vehicle routes, ordered stops, expanded graph paths, total distance, estimated fuel use, estimated carbon emissions, and unassigned tasks.
